...
├── music/
│   ├── reference_01/
│   │   ├── reference_new.wav          # Исходный референсный файл
│   │   ├── original_input.wav         # Исходный входной файл
...
1. Наличие файлов `reference_new.wav` и `original_input.wav` в каждой тестовой поддиректории.
